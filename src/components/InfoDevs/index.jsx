        ...
        <TableOnTheLeft>
          ...
          <div className="containerDevs">
            <div className="infoDevs">
              ...
              <p className="workDev">
                {dev1.work === "Quality Assurance" && (
                  <img
                    className="icon-assurance"
                    src={Assurance}
                    alt="assurance"
                  ></img>
                )}
              ...
              <p>
                <a
                  href={`${baseUrlLinkedin}${dev1.linkedin}`}
                  target="_blank"
                ...
                <a
                  href={`${baseUrlGithub}${dev1.github}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
            ...
            <div className="infoDevs">
              ...
              <p className="workDev">
                ...
                {dev2.work === "Scrum Master" && (
                  <img
                    className="icon-scrumMaster"
                    src={Scrum}
                    alt="scrumMaster"
                  ></img>
                )}
              ...
              <p>
                <a
                  href={`${baseUrlLinkedin}${dev2.linkedin}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img
                ...
                <a
                  href={`${baseUrlGithub}${dev2.github}`}
                  target="_blank"
                  rel="noopener noreferrer"
                >
                  <img className="contact-media" src={Github} alt="github" />
        ...
        <TableOnTheRight>
          <div className="containerDevs">
            <div className="infoDevs">
              ...
              <p className="workDev">
                {dev1.work}
                {dev1.work === "Product Owner" && (
                  <img
                    className="icon-productOwner"
                    src={ProductOwner}
                    alt="productOwner"
                  ></img>
                )}
            ...
            <div className="infoDevs">
              ...
              <p className="workDev">
                {dev2.work === "Tech Leader" && (
                  <img
                    className="icon-techLeader"
                    src={TechLeader}
                    alt="techLeader"
                  ></img>
                )}
